...
public class Exercise004Test {
    ...
    //New Test case for Giga second
    @Test
    public void  checkGigaSecond(){
        Exercise004 ex004=new Exercise004 (LocalDate.of(1984, Month.MAY, 3));
       // LocalDateTime expected = LocalDateTime.of(1984, Month.MAY, 3);
       // assertEquals(expected, ex004.getDateTime());
    }
